...
function ProjectView({ project, onProjectChange, projects, tasks, completed, milestones, onDone, onClearBlocker, onUpdate, onEdit, onCreateProject, onUpdateProjectStatus }) {
  ...
  return <section className="screen-content project-screen">
    <div className="project-view-header">
      ...
      <div className="project-stats" aria-label={`${project} project stats`}><div className="project-stat project-open-stat"><span>Open</span><strong>{projectTasks.length}</strong></div><div className="project-stat project-completed-stat"><span>Completed</span><strong>{projectCompleted.length}</strong></div><div className="project-stat project-next-stat"><span>Next milestone</span>{nextMilestone ? <><strong>{nextMilestone.name}</strong><small>{nextMilestone.date} · {milestoneTimingLabel(nextMilestone)}</small></> : <strong>None scheduled</strong>}</div></div>
    </div>

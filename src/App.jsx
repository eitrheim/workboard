  ...
  return <div className="app-shell">
    ...
    <div className="main-column">
      ...
      <main className="content">
        ...
        {screen === "completed" && <CompletedView completed={completed} scoreEvents={scoreEvents} period={period} setPeriod={setPeriod} onUndo={undoCompleted} />}
      </main>
